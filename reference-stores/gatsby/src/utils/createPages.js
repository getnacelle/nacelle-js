...
const ProductsQuery = require('../queries/pages/products');
const CollectionsQuery = require('../queries/pages/collections');
const ContentQuery = require('../queries/pages/content');
const SearchQuery = require('../queries/pages/search');
